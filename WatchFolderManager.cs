...
{
    /// <summary>
    /// Class <c>WatchFolderManager</c> manages a collection of folders to watch for changes and perform actions accordingly.
    /// </summary>
    public class WatchFolderManager : IDisposable
    {
        /// <summary>
        /// Property <c>WatchFolders</c> gets the list of watch folders currently being managed.
        /// </summary>
